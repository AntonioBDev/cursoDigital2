    ...
    <main className="container mx-auto px-5 my-10 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div className="bg-slate-900 p-4 border rounded-2xl bg-borde border-transparent hover:drop-shadow-[0_0_8px_rgba(168,85,247,1)]">
          ...
          <p className="text-lg md:text-xl text-slate-300 pt-4">
           Gente que está buscando crear algo que realmente les <span className="text-slate-100 font-extrabold">genere más ingresos </span> que lo que hacen hoy.
          </p>
        </div>
        ...
        <div className="bg-slate-900 p-4 border rounded-2xl bg-borde border-transparent hover:drop-shadow-[0_0_8px_rgba(168,85,247,1)]">
          ...
          <p className="text-lg md:text-xl text-slate-300 pt-4">
            No es por asustar, pero este modelo ya va de salida en varios mercados. Por eso, en lugar de depender de terceros, es mejor <span className="text-slate-100 font-extrabold">construir algo propio…</span> con productos de bajo costo, pero <span className="text-slate-100 font-extrabold">vendiendo en volumen</span>, como ya lo están haciendo muchos.
          </p>
        </div>
        ...
        <div className="bg-slate-900 p-4 border  rounded-2xl bg-borde border-transparent hover:drop-shadow-[0_0_8px_rgba(168,85,247,1)]">
          ...
          <p className="text-lg md:text-xl text-slate-300 pt-4">
            Gente <span className="text-slate-100 font-extrabold">sin conocimientos digitales,</span> pero con disciplina para crear algo que les dé <span className="text-slate-100 font-extrabold">más libertad</span> y menos dependencia de un jefe.
          </p>
        </div>
      </div>
    </main>
