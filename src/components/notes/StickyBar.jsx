...
export default function StickyBar() {
  return (
    <div className="fixed bottom-2 md:bottom-4 left-2 right-2 w-auto z-50 bg-slate-900/95 backdrop-blur-md border rounded-3xl border-purple-500/30 p-4 md:p-6 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
